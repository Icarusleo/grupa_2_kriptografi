...
class Rabbit(object):
    ...
    def set_key(self,key):
        ...
        key0=int.from_bytes(key[0:4], byteorder='little')
        key1=int.from_bytes(key[4:8], byteorder='little')
        key2=int.from_bytes(key[8:12], byteorder='little')
        key3=int.from_bytes(key[12:16], byteorder='little')
        s=self.ctx.m
    ...
    def set_iv(self,iv):
        ...
        v=[0]*4
        v[0]=int.from_bytes(iv[0:4], byteorder='little')
        v[2]=int.from_bytes(iv[4:8], byteorder='little')
...
if __name__ == "__main__":
    ...
    check(st(key1), b"",st(out1))
    check(st(key2), b"",st(out2))
    check(st(key3), b"",st(out3))
